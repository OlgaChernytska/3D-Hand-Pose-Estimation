...
class MyModel1(nn.Module): # input size 256x256
    def __init__(self, n_keypoints=21):
        ...
        self.keypoints_2d_prediction = nn.Sequential(
            ...
            nn.Linear(200, 2*n_keypoints, bias=True)
        ) 
    ...
    def forward(self, sample):
        ...
        out_2d = self.keypoints_2d_prediction(features.view(features.size(0), -1))
        
        return {'vector_2d': out_2d, 'vector_3d': out_3d}
